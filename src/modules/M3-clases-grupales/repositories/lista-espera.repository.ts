...
export class ListaEsperaRepository {
  ...
  async crearInscripcion(id_clase: number, id_usuario: number, fecha_inicio: Date, fecha_fin: Date) {
  ...
  async existeInscripcionActiva(id_clase: number, id_usuario: number, fecha_inicio: Date, fecha_fin: Date) {
